...
export default component$(() => (
  ...
  <>
    ...
    >
        ...
        <ul class="space-y-2">
          ...
          <li>
            ...
            >
              ...
              <span class="inline-flex h-5 w-5 items-center justify-center rounded-full bg-primary-100 text-xs font-semibold text-primary-800 dark:bg-primary-200 dark:text-primary-800">
                4
              </span>
            </a>
          </li>
      ...
      <div class="absolute bottom-0 left-0 z-20 hidden w-full justify-center space-x-4 bg-white p-4 dark:bg-gray-800 lg:flex">
        <a
          href="#"
