...
interface AsideComponentProps
  extends HTMLAttributes<HTMLElementTagNameMap["aside"]> {
  // more ...props
}

interface AsideHeaderComponentProps
  extends HTMLAttributes<HTMLElementTagNameMap["header"]> {
  // more ...props
}

interface AsideFooterComponentProps
  extends HTMLAttributes<HTMLElementTagNameMap["footer"]> {
  // more ...props
}

interface AsideContentComponentProps
  extends HTMLAttributes<HTMLElementTagNameMap["section"]> {
  // more ...props
}
...
interface AsideSectionComponentProps
  extends HTMLAttributes<HTMLElementTagNameMap["ul"]> {
  // more ...props
}

const Header = component$<AsideHeaderComponentProps>(
  ({ class: classList, ...props }) => (
    <header
      {...props}
      class={cn("p-4 text-center text-2xl font-semibold text-white", classList)}
    >
      <Slot />
    </header>
  ),
...
const Content = component$<AsideContentComponentProps>(
  ({ class: classList, ...props }) => (
    <section
      {...props}
      class={cn(
        "h-full overflow-y-auto bg-white px-3 py-5 dark:bg-gray-800",
        classList,
      )}
    >
      <Slot />
...
const Footer = component$<AsideFooterComponentProps>(
  ({ class: classList, ...props }) => (
    <footer
      {...props}
      class={cn(
        "absolute bottom-0 left-0 z-20 hidden w-full justify-center space-x-4 bg-white p-4 dark:bg-gray-800 lg:flex",
        classList,
      )}
    >
      <a
...
const AsideMain = component$<AsideComponentProps>(
  ({ class: classList, ...props }) => (
    <aside
      {...props}
      aria-label="Sidenav"
      ...
      class={cn(
        "fixed left-0 top-0 z-40 h-screen w-64 -translate-x-full border-r border-gray-200 bg-white pt-14 transition-transform dark:border-gray-700 dark:bg-gray-800 md:translate-x-0",
        classList,
      )}
    >
      <Slot name="header" />
...
const Section = component$<AsideSectionComponentProps>(
  ({ class: classList, ...props }) => (
    <ul {...props} class={cn("space-y-2", classList)}>
      <Slot />
    </ul>
  ),
);
